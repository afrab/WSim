...
\author{Loïc Lemaître, Antoine Fraboulet}


\begin{document}
  \maketitle

  \abstract{This document is aimed to help developers that would like
    to create or complement modules on WSim. It is not a full
    description of WSim source code, but a short introduction to allow
    to understand its architecture. It also gives some ways to debug
    your WSim code.}
...
%-Correspond aux échéances du traitement des interruptions
%-Ecriture des modèles de périphériques en conséquences
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% there are several traps, I have validated them in the current version. You can trigger 
%% them using special macros like these:
%%
%% #define __BREAK__                \
%%    asm( "break_gdb :      \n"    \
%%         " mov r6, r6      \n");
%%
%% Registers 4 to 15 can be used to generate breakpoints. Registers 4 & 5 ("mov r4,r4" and 
%% "mov r5,r5") are already used by the energy estimation tool.
%%
%% For special purpose things you can have a look in /arch/msp430/msp430_alu.c:1280
%% and do on-demand things using a "mov rx,rx". To trigger a GDB event you should do
%%
