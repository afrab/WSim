...
/* addresses correspond to memory access 0x60 is mapped to 0x00, address must be adapted */
#if 0
static struct atmega128_io_addr_fptr_t atmega128_io_ext_addr_fptr[] = {
  ...
  { .read = atmega128_read8_sigbus, .write = atmega128_write8_sigbus, .name = "Reserved" }, /* 0x9E */
  /*  ..  Reserved */
  { .read = atmega128_read8_sigbus, .write = atmega128_write8_sigbus, .name = "Reserved" }  /* 0xFF */
