...
int machine_create()
{
  ...
  tracer_event_add_id(TRACER_MCU_PC,    "mcu_PC",         32); 
  tracer_event_add_id(TRACER_MCU_GIE,   "mcu_gie",         1);
  tracer_event_add_id(TRACER_MCU_INTR,  "mcu_interrupt",  32);
  tracer_event_add_id(TRACER_MCU_POWER, "mcu_power_mode", 32);
  tracer_event_add_id(TRACER_MCU_PORT1, "mcu_port_out_1", 32);
  tracer_event_add_id(TRACER_MCU_PORT2, "mcu_port_out_2", 32);
  tracer_event_add_id(TRACER_MCU_PORT3, "mcu_port_out_3", 32);
  tracer_event_add_id(TRACER_MCU_PORT4, "mcu_port_out_4", 32);
  tracer_event_add_id(TRACER_MCU_PORT5, "mcu_port_out_5", 32);
  tracer_event_add_id(TRACER_MCU_PORT6, "mcu_port_out_6", 32);
  tracer_event_add_id(TRACER_USART0,    "Usart0",         32);
  tracer_event_add_id(TRACER_USART1,    "Usart1",         32);
