 ...
 *
 */
#include "random_billiard_mobility.h"
...
/**************************************************************************/
/**************************************************************************/
struct _random_billiard_mobility_private
{
  double direction;
  double speed;
...
/**************************************************************************/
/**************************************************************************/
static char key_private[] = "RANDOM_BILIARD";
...
int random_billiard_mobility_instantiate(struct _node * node, FILE * config_fd)
{
  ...
  if (fscanf(config_fd, "%lf %lf", &speed_min, &speed_max) != 2)
    {
